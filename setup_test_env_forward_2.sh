...
echo "  sudo ip netns exec server ./build/edge server 10.9.0.254 ${SERVER_PORT} certs/server_cert.pem certs/server_key.pem"
echo ""
...
echo "  sudo ip netns exec client ./build/edge client 10.8.0.1  ${FORWARD_IN_PORT} ${FORWARD_IP_1_1}"
echo ""
