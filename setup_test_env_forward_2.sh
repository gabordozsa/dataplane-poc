...
echo "  sudo ip netns exec server ./build/edge_server ${SERVER_PORT} certs/server_cert.pem certs/server_key.pem 10.9.0.254"
echo ""
...
echo "  sudo ip netns exec client ./build/edge_client ${FORWARD_IP_1_1} ${FORWARD_IN_PORT}  10.8.0.1"
echo ""
